...
def update_record():
    if request.method == 'POST':
        ...
        return render_template('add-update.html', show_result=True, result_html=result_app, not_valid=False, action_name='update', developer_name='Yunus') #Again, There is no message shown by user here. Thats why not valid is going to be False.
    else:
...
def delete_record():
    if request.method == 'POST':
        ...
        return render_template('delete.html', show_result=True, result_html=result_app, not_valid=False, developer_name='Yunus') # In addition, There will be no message to be shown to the user here. Thats why not valid is going to be False.
    else:
